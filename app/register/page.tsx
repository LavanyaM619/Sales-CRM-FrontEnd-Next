    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">Admin Dashboard</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    {...register('name', { required: 'First name is required', minLength: { value: 2, message: 'First name must be at least 2 characters' } })}
                    type="text"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none rounded-md relative block w-full pl-10 pr-10 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <a href="/login" className="font-medium text-primary-600 hover:text-primary-500">Sign in</a>
            </p>
          </div>
        </form>
      </div>
